...
{
    [Table("attivita_750")]
    public class Attivita750
    {
        [Key]
        [Column("id_attivita_750")]
        public int IdAttivita750 { get; set; }
        ...
        [Column("file_isa_disponibile")]
        public bool FileIsaDisponibile { get; set; } = false;
        ...
        [Column("bilancio")]
        [MaxLength(20)]
        public string Bilancio { get; set; } = "da_chiudere";
        ...
        [Column("ricevuta_dr")]
        public bool RicevutaDr { get; set; } = false;
