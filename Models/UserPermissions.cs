...
namespace ConsultingGroup.Models
{
    public class UserPermissions
    {
        ...
        // Area Amministrativa - Solo Admin + Senior (Gestione Amministrativa)
        public bool CanAccessAreaAmministrativa { get; set; } = false;
        
        // Anagrafiche - Gestione anagrafe clienti/fornitori
        public bool CanAccessAnagrafiche { get; set; } = true;
        
        // Gestione Attività - Gestione attività redditi, IVA e contabili
