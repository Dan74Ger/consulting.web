...
{
    /// <inheritdoc />
    public partial class CreateAttivita750Table : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_attivita_750 = table.Column<int>(type: "int", nullable: false)
                    ...
                    file_isa_disponibile = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    bilancio = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    ricevuta_dr = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_attivita_750", x => x.id_attivita_750);
                    table.ForeignKey(
                        name: "FK_attivita_750_anni_fiscali_id_anno",
                        column: x => x.id_anno,
                        principalTable: "anni_fiscali",
                        principalColumn: "id_anno",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_attivita_750_clienti_id_cliente",
                        column: x => x.id_cliente,
                        principalTable: "clienti",
                        principalColumn: "id_cliente",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_attivita_750_professionisti_id_professionista",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_attivita_750_id_anno",
                table: "attivita_750",
                column: "id_anno");

            migrationBuilder.CreateIndex(
                name: "IX_attivita_750_id_cliente",
                table: "attivita_750",
                column: "id_cliente");

            migrationBuilder.CreateIndex(
                name: "IX_attivita_750_id_professionista",
                table: "attivita_750",
