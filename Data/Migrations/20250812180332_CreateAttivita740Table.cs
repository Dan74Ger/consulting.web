...
{
    /// <inheritdoc />
    public partial class CreateAttivita740Table : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_attivita_740 = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_attivita_740", x => x.id_attivita_740);
                    table.ForeignKey(
                        name: "FK_attivita_740_anni_fiscali_id_anno",
                        column: x => x.id_anno,
                        principalTable: "anni_fiscali",
                        principalColumn: "id_anno",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_attivita_740_clienti_id_cliente",
                        column: x => x.id_cliente,
                        principalTable: "clienti",
                        principalColumn: "id_cliente",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_attivita_740_professionisti_id_professionista",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_attivita_740_id_anno",
                table: "attivita_740",
                column: "id_anno");

            migrationBuilder.CreateIndex(
                name: "IX_attivita_740_id_cliente",
                table: "attivita_740",
                column: "id_cliente");

            migrationBuilder.CreateIndex(
                name: "IX_attivita_740_id_professionista",
                table: "attivita_740",
